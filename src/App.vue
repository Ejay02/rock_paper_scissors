  ...
  <div class="bg-gray-700 text-white text-center min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-6 flex-1">
      ...
      >
        ...
        <button
          @click="play('paper')"
          class="bg-white rounded-full shadow-lg w-64 p-12 mx-6 transition-colors duration-300 hover:bg-indigo-500"
        >
      ...
      <div v-else>
        ...
        <button
          @click="ResetRound"
          class="bg-black rounded-md text-lg py-2 px-4"
        >
          Reset
        </button>
      </div>
    ...
    <footer class="container mx-auto p-6">
      <a href="https://www.vecteezy.com/free-vector/rock-paper-scissors-game"
